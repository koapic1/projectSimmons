                                ...
                                if (!(i.ignoreFocusChange || ["init", "closing", "customClosing", "destroy"].indexOf(this.state) > -1)) {
                                    ...
                                    if (n) {
                                        ...
                                        for (
                                            ...
                                            var c = l[r],
                                                h = n.contains(c);
                                            !c.offsetParent || (!h && this.Carousel.$viewport.contains(c))
                                                ? ((c.dataset.origTabindex = void 0 === c.dataset.origTabindex ? c.getAttribute("tabindex") : c.dataset.origTabindex), (c.tabIndex = -1))
                                                : (s.push(c),
                                                  void 0 !== c.dataset.origTabindex && ((c.tabIndex = c.dataset.tabindex), c.removeAttribute("data-tabindex")),
                                                  (c.hasAttribute("autoFocus") || (!o && h)) && (o = c));
                                        }
